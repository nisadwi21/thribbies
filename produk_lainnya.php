...
<head>
  <meta charset="UTF-8">
  <title>Produk Lainnya - Thribbies</title>
  <link rel="stylesheet" href="css/lainnya.css" />
...
<div class="produk-grid">
  <?php if (mysqli_num_rows($query) > 0) : ?>
    ...
    <?php endwhile; ?>
  <?php else : ?>
    <p class="produk-kosong">Produk tidak ditemukan.</p>
  <?php endif; ?>
</div>


<div style="text-align:center; margin: 30px 0;">
  <a href="index.php" class="btn-lihat-lebih">Kembali ke Beranda</a>
</div>
<footer>
